return {
    'folke/snacks.nvim',
    enabled = not vim.g.disable_snacks,
    dependencies = {
    ...
    opts = {
        ...
        indent = {
            ...
            only_current = false,
            enabled = true,
            scope = { enabled = true, underline = true, priority = 200 }
        },
        dim = {},
        animate = { easing = 'outBack', fps = 75, duration = 20 },
        toggle = {},
        git = {},
        debug = {},
    ...
    keys = {
        -- { '<leader>sT', function() Snacks.picker.colorschemes() end },
            {
                '<leader>ud',
                function()
            ...
            { "<leader>sk", function()
                Snacks.picker.keymaps {
                    ['local'] = true, plugs = true, global = true,
                }
            end, desc = "Keymaps" },
            {
                "<leader>sl",
